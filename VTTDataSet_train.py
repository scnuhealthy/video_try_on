...
class VTTDataSet(data.Dataset):
    """
        Dataset for CP-VTON.
    """
    def __init__(self, opt, level='video'):
    ...
    def getitem_image(self, index):
        ...
        high_frequency_map = transforms.Resize(self.fine_width, interpolation=2)(high_frequency_map)
