...
class VideoPipeline(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin):
    ...
    def cond_fn(
        ...
        loss_clip = spherical_dist_loss(image_embeddings_clip, original_image_embeddings_clip).mean()
    ...
    def __call__(
        ...
        # guided
        cloth_clip_image_embeddings = self.get_clip_image_embeddings(cloth, window_size, device=device)
            ...
            with self.progress_bar(total=num_inference_steps) as progress_bar:
                for i, t in enumerate(timesteps):
                    ...
                    for t_start, t_end in views:
                        ...
                        # guided diffusion
                        if is_guide and t < 900 and t>300:
                            for p in range(1):
