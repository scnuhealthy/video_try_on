...
class VideoPipeline(DiffusionPipeline, TextualInversionLoaderMixin, LoraLoaderMixin):
    ...
    def __call__(
        ...
        batch_size = 1
        video_length = masked_image.shape[0]//batch_size
        ...
        # print('1111',latents.shape, high_frequency_map_latents.shape, masked_image_latents.shape, pose_embeds.shape)
        views = get_views(video_length,window_size=32,stride=16)
