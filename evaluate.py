...
def get_opt():
    ...
    parser.add_argument('--predict_dir', default='./VITON_test_paired_0921')
    parser.add_argument('--ground_truth_dir', default='/data1/hzj/zalando-hd-resized/test/image')
    # parser.add_argument('--predict_dir', default='./DressCode_test_paired')
    # parser.add_argument('--ground_truth_dir', default='/data1/hzj/DressCode/upper_body/test_images/')
